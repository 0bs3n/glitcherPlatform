...
set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { glitch_out_en }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { glitch_mode }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { reset_mask }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
...
##Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { LPC_reset }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { delay_up }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { delay_dn }]; #IO_L11N_T1_SRCC_16 Sch=btn[2]
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { step_mode }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
...
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { _reset }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { glitch_mon }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { etrig }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { glitch_out }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { swdio }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { swclk }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
...
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { board_rx }]; #IO_L19N_T3_A09_D25_VREF_14        Sch=ck_io[26]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { board_tx }]; #IO_L16N_T2_A15_D31_14             Sch=ck_io[27]
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { board_rst }]; #IO_L6N_T0_D08_VREF_14 Sch=ck_io[28]
